...
<!-- The shared guides sidebar. Emitted by the generator, never hand-added: this
     script rewrites pcm-design-catalog.html end to end, so a tag added to the
     shipped HTML would vanish on the next rebuild. guide-nav.js reads the same
     `family` test as the head script above and injects nothing in ?family view. -->
