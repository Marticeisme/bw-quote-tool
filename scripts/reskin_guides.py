...
def reskin(path, cover_footer, add_stripe):
    ...
    cover = (f'<div class="doc-sheet">\n\n  <div class="cover">\n'
             ...
             f'    <div class="cover-kicker">BONNEY WATSON FAMILY GUIDE</div>\n'
             f'    <h1>{h1}</h1>\n'
    ...
    # ---- toc-wrap -> contents ----
    # The block ends with </ol></div>; anchoring on </div></div> overshoots
    # into Section 1 (these TOCs use an <ol>, not nested divs).
