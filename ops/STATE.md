...
**Current sprint:** **sprint-06 — CLOSED 2026-07-28, awaiting the operator push gate.** All five
tracks done and merged: R (research), M (`s06/mvc-niche-map`), G (`s06/terramation-guide`),
M2 (map repo `469c25d`), M3 (`s06/mvc-3d`). Local `main` is 12 ahead of origin, fully green.
