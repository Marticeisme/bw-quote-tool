...
| Assertion suites | `npm test` | `1799 passed, 0 failed across 34 suites (1797 without wmp-cemetery-map/)` — updated s11: +58 marker-guide-prices, +67 pcm-catalog, +42 walkthrough-path, +94 catalog-filter-print |
